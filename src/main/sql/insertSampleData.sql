...
insert into cards(name, description, duedate, listid, boardid) values
    ('Viena','Austria',null,null,lastboardid),
    ('Roma','Italia',null,null,lastboardid),
    ('Llanfairpwllgwyngyllgogerychwyrndrobwllllantysiliogogogoch','Pais de Gales',null,null,lastboardid);
...
insert into cards(name, description, duedate, listid, boardid) values
    ('Avião','Comprar os bilhetes para todos','2023-04-15 12:30:00',lastlistid,lastboardid),
    ('Hotel','Reservar os quartos (para quantos?)','2023-05-01 12:00:00',lastlistid,lastboardid),
    ('Transportes','De e para o aeroporto','2023-06-09 23:59:59',lastlistid,lastboardid);
