...
var parameters = null
if (substrings) {
    parameters = substrings.map(match => match.replace(regex_s, "$1"));
}
...
var kargs = {}
        var args = path.match(route.regex).slice(1);
if(args.length>0){
